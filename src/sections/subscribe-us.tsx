    ...
    <Box as="section" sx={styles.section} variant="section.subscribe">
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Tertarik dengan layanan kami? yuk Langganan"
            description="Kami memiliki lebih dari 100 portofolio website yang bisa kalian lihat"
          />
          <Box as="form" sx={styles.subscribe} onSubmit={handleSubmit}>
            ...
            <Box sx={styles.checkbox}>
              <Label htmlFor="no_spam" className={checked ? 'checked' : ''}>
                ...
                />
                Jangan berikan pesan promosi apa pun.
              </Label>
              {/* <Checkbox
                id="no_spam"
                checked={checked}
                onChange={handleCheckbox}
                label="Jangan berikan pesan promosi apa pun."
              /> */}
            </Box>
          </Box>
        </Box>
...
const styles = {
  section: {
    background: [
      ...
      null,
      null,
      `#F8F0EA url('assets/images/subscribe-bg.png') no-repeat center bottom / contain`,
    ],
