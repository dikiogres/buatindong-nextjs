...
/** @jsx jsx */
import {} from 'react'
import { jsx, Box, Container, Heading, Text, ThemeUIStyleObject } from 'theme-ui';
...
const data = [
  {
    id: 1,
    tabTitle: 'Kenapa kami?',
    title: `Kami akan mengubah ide Anda menjadi kerangka model bisnis yang sukses`,
    description: `Mampu melakukan manajemen strategis untuk mendefinisikan serta mengkomunikasikan ide atau konsep bisnis dengan cepat dan mudah..`,
  ...
  {
    id: 2,
    tabTitle: 'Apa janji bisnis kami?',
    title: `Memberikan hasil terbaik dengan usaha yang maksimal `,
    description: `Semua alur pekerjaan kita buat secara transparan sehingga pihak klien dapat dengan nyaman mempercayakan pekerjaan kepada kami..`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      '4 Sehat',
  ...
  {
    id: 3,
    tabTitle: 'Bagimana kata mereka?',
    title: `Tidak pernah mengecewakan sejak 17 Agustus 1945`,
    description: `Kami menyediakan revisi dengan jumlah tidak terbatas sampai anda puas..`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Revisi 1',
